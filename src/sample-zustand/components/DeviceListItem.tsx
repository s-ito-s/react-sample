...
function DeviceListItem( {id, name, model, onDelete, onUpdate}: DeviceListItemProps ) {
  ...
  const DeviceListItemEditor = ({initialName, initialModel, onClickUpdateButton}: DevictListItemEditorProps) => {
      ...
      <tr key={id}>
        ...
        <td>
          <div className="device-list-item-button-area">          
            ...
            <button onClick={() => {onClickUpdateButton(newName, newModel)}}>
              update
            </button>
          </div>
        </td>
